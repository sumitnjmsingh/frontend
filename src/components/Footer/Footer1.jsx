  ...
  return (
    ...
    <div className='flex flex-col lg:gap-[25px] md:gap-[60px] justify-start'>
        ...
        <div className='grid grid-cols-5 lg:mt-[60px] md:mt-[40px]'>
            <div className='text-[30px] st:text-[15px]'><FaInstagram /></div>
            <div className='text-[30px] st:text-[15px]'> <FaFacebook /></div>
            <div className='text-[30px] st:text-[15px]'><FaGithub /></div>
            <div className='text-[30px] st:text-[15px]'><FaSquareXTwitter /></div>        
        </div>
    </div>
    </div>
    ...
    <div className=' h-[100%] grid grid-cols-[45%_55%]'>
        <div className='grid grid-cols-1  justify-items-start pl-10'>
          ...
          <div className='flex text-[1.2rem]  md:text-[2rem] st:text-[15px] text-white justify-around items-center  gap-2 md:gap-2'><div  ><FcApproval/></div><div><SlSocialLinkedin /></div><div><TiSocialYoutube /></div><div><SlSocialInstagram /></div><div><SlSocialPintarest /></div><div><FaGithub /></div></div>
