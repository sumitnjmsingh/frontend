...
function Front_food() {
  ...
  return (
   ...
   <div className={`w-[${val}%] max-w-[1600px]  transition-width duration-500 linear`}>
    ...
    <div className=' h-[60px] grid grid-cols-[40px_4fr_3fr_40px] st:grid-cols-[40px_2fr_5fr_40px] sticky top-0 left-0 bg-[#f0dada] z-[234]  '>
        <div className=' col-start-2'></div>
        <div className=' col-start-3 grid grid-cols-5 st:grid-cols-[2fr_1fr_1fr_1fr_1fr] gap-x-[5px]'>

            <div className=' grid grid-cols-[3fr_1fr] place-items-center'>
                <div><input type="text" className='lg:w-[65px] st:w-[40px] md:w-[45px] rounded-[20px] border-[solid] border-[black] border-[2px] p-[2px] bg-[#f0dada]' placeholder='Enter food...'></input>
                
                </div>
                <div className='lg:text-[30px] md:text-[20px]'><FaSearch /></div>
            </div>
            <div className='  grid grid-cols-[3fr_1fr] place-items-center '>
                <div className='st:text-[8px]'>Latest Offers</div>
                <div className='lg:text-[30px] md:text-[20px] ' ><BiSolidOffer /></div>
            </div> 
            <div className=' grid grid-cols-[3fr_1fr] place-items-center'>
                <div className='st:text-[8px]'>Help Center</div>
            ...
            <div className=' grid grid-cols-[3fr_1fr] place-items-center '>
                <div className='st:text-[8px]' ><DrawerPlacement className="z-999999 " callback={setval} callback2={setcheck}/></div>
                <div className='text-[40px]  flex relative overflow-hidden '><TiShoppingCart className='z-[-1]' /><div className=' text-white font-semibold border-[solid] border-[2px] border-[red] flex text-[15px] w-[19px] h-[19px] justify-center items-center rounded-full bg-[red] absolute top-0 right-0 z-[-1]'>{count}</div></div>
            </div>
        </div> 
    ...
    <div className='h-[100%]  grid grid-cols-[20%_80%] p-[10px] '>
        <div className=' h-[100vh] sticky top-20 p-[10px] '>
            <ul className=' st:gap-[34px] md:gap-[34px] lg:gap-[20px] place-items-center w-[100%] h-[100%] grid grid-cols-1 grid-rows-10'>
                ...
                <li className={`bg-[#484242] text-white border-[solid] border-[black]  h-[40px]  lg:w-[200px] st:w-[75px] st:text-[10px]  md:w-[90px] md:text-[13px] border-[3px] rounded-[20px] p-[8px]`}>Salads</li>
                <li className={`bg-[#484242] text-white border-[solid] border-[black]  h-[40px]  lg:w-[200px] st:w-[75px] st:text-[10px]  md:w-[90px] md:text-[13px] border-[3px] rounded-[20px] p-[8px]`}>Appetizers</li>
                <li className={`bg-[#484242] text-white border-[solid] border-[black]  h-[40px]  lg:w-[200px] st:w-[75px] st:text-[10px]  md:w-[90px] md:text-[13px] border-[3px] rounded-[20px] p-[8px]`}>Lite Bite</li>
                <li className={`bg-[#484242] text-white border-[solid] border-[black]  h-[40px]  lg:w-[200px] st:w-[75px] st:text-[10px]  md:w-[90px] md:text-[13px] border-[3px] rounded-[20px] p-[8px]`}>Sandwitches</li>
                <li className={`bg-[#484242] text-white border-[solid] border-[black]  h-[40px]  lg:w-[200px] st:w-[75px] st:text-[10px]  md:w-[90px] md:text-[13px] border-[3px] rounded-[20px] p-[8px]`}>Desserts</li>
                <li className={`bg-[#484242] text-white border-[solid] border-[black]  h-[40px]  lg:w-[200px] st:w-[75px] st:text-[10px]  md:w-[90px] md:text-[13px] border-[3px] rounded-[20px] p-[8px]`}>Burgers</li>
                <li className={`bg-[#484242] text-white border-[solid] border-[black]  h-[40px]  lg:w-[200px] st:w-[75px] st:text-[10px]  md:w-[90px] md:text-[13px] border-[3px] rounded-[20px] p-[8px]`}>breakfast</li>
    ...
    <div className='h-[50vh]  grid grid-cols-[1fr_1fr_1fr_1fr_2.5fr] pt-[30px] border-t-[solid] border-t-[black] border-t-[2px] rounded-[5px]'>
        <div>
            <ul className='flex flex-col lg:gap-[40px] st:gap-[55px] place-items-center font-semibold lg:text-[20px] st:text-[8px]'>
    ...
    <div className='flex flex-col lg:gap-[25px] md:gap-[60px] justify-start'>
        ...
        <div className='flex'>
              <input type="email" placeholder='Enter your email....' className='border-[solid] border-[black] border-[2px] rounded-[5px] lg:w-[400px] md:h-[35px] st:w-[150px] lg:h-[45px] st:h-[35px] p-[20px]'></input>
              <div className='border-[solid] border-[black] border-[2px] rounded-[5px] lg:w-[100px] st:w-[30px] st:text-[10px]  h-[45px] p-[10px] bg-[black] text-[white] overflow-hidden'>SUBSCRIBE</div>
        </div>
    ...
    <div className='h-[30vh] bg-black overflow-hidden'>
